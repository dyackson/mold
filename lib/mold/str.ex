defmodule Mold.Str do
  ...
  defimpl Mold do
    ...
    defp local_prep!(%Spec{one_of: one_of} = mold) when is_list(one_of) do
    ...
    defp local_prep!(%Spec{one_of_ci: one_of_ci} = mold) when is_list(one_of_ci) do
    ...
    defp local_prep!(%Spec{regex: regex} = mold) when not is_nil(regex) do
      case regex do
        %Regex{} -> mold
    ...
    defp local_prep!(%Spec{} = mold), do: mold

    defp add_error_message(%Spec{error_message: nil} = mold) do
    ...
    defp add_error_message(%Spec{} = mold), do: mold
